...
parser.add_argument('--textfeature_mode', default='textf1', help='concat2/textf1/textf2')

parser.add_argument('--rnn_n_layers', type=int, default=2, help='rnn_n_layers')
parser.add_argument('--rnn_drop', type=float, default=0.2, metavar='dropout', help='dropout rate')
parser.add_argument('--rnn_type', default='gru', help='gru/rnn')
...
parser.add_argument('--cross_hidden_dim', type=int, default=512, help='cross_hidden_dim')
parser.add_argument('--cross_n_layers', type=int, default=5, help='cross_n_layers')
parser.add_argument('--cross_num_head', type=int, default=8, help='cross_num_head')
parser.add_argument('--cross_drop', type=float, default=0.4, metavar='dropout', help='dropout rate')
